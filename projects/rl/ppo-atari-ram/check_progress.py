#!/usr/bin/env python3
"""Check PPO Atari RAM training progress — process, GPU, log, CSV, PNGs, checkpoints."""
import os
import json
import subprocess
import time

OUT = "/content/ppo-atari-output"
...
if __name__ == "__main__":
    print("=== PPO Atari RAM Training Progress ===\n")
    check_process()
    check_gpu()
    print()
    tail_log(12)
