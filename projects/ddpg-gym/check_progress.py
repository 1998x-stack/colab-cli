#!/usr/bin/env python3
"""Check training progress — tail log, show metrics, find latest plots."""
import os
import json
import subprocess

OUT = "/content/ddpg-output"
LOG_PATH = f"{OUT}/train.log"
METRICS_PATH = f"{OUT}/metrics.json"
PLOTS_DIR = f"{OUT}/plots"

def check_process():
    """Find if train.py is still running."""
    try:
...
def tail_log(n=20):
    """Show last N lines of training log."""
